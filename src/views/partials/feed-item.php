    ...
    <div class="box-body">
        <div class="feed-item-head row mt-20 m-width-20">
            <div class="feed-item-head-photo">
                <a href="<?=$base;?>/perfil/<?=$data->user->id;?>"><img src="<?php echo BASE_URL; ?>media/avatars/<?= $data->user->avatar; ?>" /></a> 
            </div>
            ...
            <?php if($data->mine): ?>
                <div class="feed-item-head-btn">
                    <img src="<?php echo BASE_URL; ?>assets/images/more.png" />
        ...
        <div class="feed-item-body mt-10 m-width-20">
            <?php 
                switch($data->type) {
                    ...
                    case 'photo':
                        echo '<img src="'.$base.'/media/uploads/'.$data->body.'" alt = "Foto postada"/>';
                    break;                    
                }
            ?>
        </div>
        ...
        <div class="feed-item-comments">
            ...
            <div class="fic-answer row m-height-10 m-width-20">
                <div class="fic-item-photo">
                    <a href="<?=$base;?>/perfil/<?=$data->user->id;?>"><img src="<?php echo BASE_URL; ?>media/avatars/<?=$loggedUser->avatar?>" /></a>
                </div>
